...
export type Transaction = {id:string; description:string; amount:number; date:string; type:'income'|'expense'|'transfer'; account:string; destination?:string; category:string; status:'paid'|'pending'};
export type Account = {id:string; name:string; opening:number; currency:Currency; color:string};
